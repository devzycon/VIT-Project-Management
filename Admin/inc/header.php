...
if (isset($_GET['action']) && $_GET['action'] == 'logout') {
 ...
 ?>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary card-header">
        <a class="navbar-brand" href="index.php"><i class="fas fa-home mr-2"></i>BTECH project management system (SCOPE)</a>
